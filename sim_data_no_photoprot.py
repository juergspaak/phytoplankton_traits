...
save_string = "data/data_no_photoprotection{}.csv".format(save)
ret_length = 5
...
def find_EF(present_species, n_com, sky, lux, envi, photoprotection = True):
...
while (timer()-start<1800 - average_over_10) and i < iters:
    ...
    dens, ret_values = find_EF(present_species,
            n_com, skys[i], lux[i], environments[i], photoprotection = False)
